    ...
    protected void agirGN(int pos) {
        switch (pos) {
            case 1 -> {
                ...
                else{atacar(Jogo.getLista21().get(0), Jogo.getLista22().get(0));}
            }case 2 -> {
                if (Jogo.getLista21().isEmpty() && Jogo.getLista23().isEmpty()) {atacar(Jogo.getLista22().get(0));}
                else if(Jogo.getLista21().isEmpty()){atacar(Jogo.getLista22().get(0), Jogo.getLista23().get(0));}
                else if(Jogo.getLista23().isEmpty()){atacar(Jogo.getLista22().get(0), Jogo.getLista21().get(0));}
                else{atacar(Jogo.getLista22().get(0), Jogo.getLista21().get(0), Jogo.getLista23().get(0));}
            }case 3 -> {
                if (Jogo.getLista22().isEmpty() && Jogo.getLista24().isEmpty()) {atacar(Jogo.getLista23().get(0));} 
                else if(Jogo.getLista22().isEmpty()){atacar(Jogo.getLista23().get(0), Jogo.getLista24().get(0));} 
                else if(Jogo.getLista24().isEmpty()){atacar(Jogo.getLista23().get(0), Jogo.getLista22().get(0));} 
                else{atacar(Jogo.getLista23().get(0), Jogo.getLista22().get(0), Jogo.getLista24().get(0));}
            }case 4 -> {
                if (Jogo.getLista23().isEmpty()) {atacar(Jogo.getLista24().get(0));}
                else{atacar(Jogo.getLista24().get(0), Jogo.getLista23().get(0));}
            }
        }
    }
