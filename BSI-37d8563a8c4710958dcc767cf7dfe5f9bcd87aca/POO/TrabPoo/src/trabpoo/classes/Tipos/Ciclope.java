...
public class Ciclope extends Grego{
    ...
    public void agirGN(int pos){
        switch (pos) {
            case 1 -> {atacar(Guerreiro.getLista21().get(0), Guerreiro.getLista21(), Jogo.getTurno());}
            case 2 -> {atacar(Guerreiro.getLista22().get(0), Guerreiro.getLista22(), Jogo.getTurno());}
            case 3 -> {atacar(Guerreiro.getLista23().get(0), Guerreiro.getLista23(), Jogo.getTurno());}
            case 4 -> {atacar(Guerreiro.getLista24().get(0), Guerreiro.getLista24(), Jogo.getTurno());}
        }
    }
