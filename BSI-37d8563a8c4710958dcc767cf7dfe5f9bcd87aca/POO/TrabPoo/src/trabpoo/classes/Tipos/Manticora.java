...
public class Manticora extends Grego{
    ...
    protected void agirGN(int pos) {
        switch (pos) {
            case 1 -> {
                if (Guerreiro.getLista22().isEmpty()) {atacar(Guerreiro.getLista21().get(0));} 
                else{atacar(Guerreiro.getLista21().get(0), Guerreiro.getLista22().get(0));}
            }case 2 -> {
                if (Guerreiro.getLista21().isEmpty() && Guerreiro.getLista23().isEmpty()) {atacar(Guerreiro.getLista22().get(0));}
                else if(Guerreiro.getLista21().isEmpty()){atacar(Guerreiro.getLista22().get(0), Guerreiro.getLista23().get(0));}
                else if(Guerreiro.getLista23().isEmpty()){atacar(Guerreiro.getLista22().get(0), Guerreiro.getLista21().get(0));}
                else{atacar(Guerreiro.getLista22().get(0), Guerreiro.getLista21().get(0), Guerreiro.getLista23().get(0));}
            }case 3 -> {
                if (Guerreiro.getLista22().isEmpty() && Guerreiro.getLista24().isEmpty()) {atacar(Guerreiro.getLista23().get(0));} 
                else if(Guerreiro.getLista22().isEmpty()){atacar(Guerreiro.getLista23().get(0), Guerreiro.getLista24().get(0));} 
                else if(Guerreiro.getLista24().isEmpty()){atacar(Guerreiro.getLista23().get(0), Guerreiro.getLista22().get(0));} 
                else{atacar(Guerreiro.getLista23().get(0), Guerreiro.getLista22().get(0), Guerreiro.getLista24().get(0));}
            }case 4 -> {
                if (Guerreiro.getLista23().isEmpty()) {atacar(Guerreiro.getLista24().get(0));}
                else{atacar(Guerreiro.getLista24().get(0), Guerreiro.getLista23().get(0));}
            }
        }
    }
