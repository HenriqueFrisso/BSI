...
public class LoboDeFenris extends Nordico{
    ...
    public void agirGN(int pos){
        switch (pos){
            case(1) -> atacar(Guerreiro.getLista21().get(0),Guerreiro.getLista11());
            case(2) -> atacar(Guerreiro.getLista22().get(0),Guerreiro.getLista12());
            case(3) -> atacar(Guerreiro.getLista23().get(0),Guerreiro.getLista13());
            case(4) -> atacar(Guerreiro.getLista24().get(0),Guerreiro.getLista14());
        }
    }
